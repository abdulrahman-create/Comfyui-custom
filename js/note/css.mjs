...
.pix-note-ic {
  ...
  vertical-align: -4px;
  margin: 0 2px;
  /* user-select: none stops browsers treating clicks on the icon as a
     "begin text-selection drag" gesture, which made caret placement
     flaky. The mousedown handler in core.mjs (`onIconClickPlace`)
     positions the caret on whichever side of the icon was clicked. */
  user-select: none;
